  ...
  return (
    <>
      ...
      <div
        ...
        className="lg:hidden fixed inset-0 z-40 bg-[rgba(2,4,12,0.97)] backdrop-blur-xl"
        style={{ display: "none", flexDirection: "column", alignItems: "center" }}
      >
        {/* Logo */}
        <div ref={mobileLogoRef} className="flex items-center gap-3 mt-auto mb-12">
          <Image
        ...
        <div ref={mobileSocialsRef} className="mt-auto flex items-center justify-center gap-6 pb-10 text-[var(--text-tertiary)]">
          ...
          <a href="https://stylend.gitbook.io/stylend-docs" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--text-primary)] transition-colors p-2">
      ...
      >
        ...
        <div ref={bottomRef} className="p-4 border-t border-white/[0.08]">
          <div className="flex items-center justify-center gap-3 text-[var(--text-tertiary)]">
            ...
            {/* GitBook */}
            <a href="https://stylend.gitbook.io/stylend-docs" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--text-secondary)] transition-colors">
