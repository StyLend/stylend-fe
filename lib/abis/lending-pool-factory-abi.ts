export const lendingPoolFactoryAbi = [
  ...
  },
  {
    type: "function",
    name: "chainIdToEid",
    inputs: [{ name: "chain_id", type: "uint256" }],
    ...
    inputs: [
      {
        ...
        components: [
          ...
          { name: "rateAtOptimal", type: "uint256" },
  ...
  },
  {
    type: "function",
    name: "setProtocol",
    inputs: [{ name: "protocol_addr", type: "address" }],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
    type: "function",
    name: "setIsHealthy",
    inputs: [{ name: "is_healthy_addr", type: "address" }],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
    ...
    inputs: [
      {
        ...
        components: [
          ...
          { name: "borrowToken", type: "address" },
          { name: "ltv", type: "uint256" },
          { name: "supplyLiquidity", type: "uint256" },
          { name: "baseRate", type: "uint256" },
          { name: "rateAtOptimal", type: "uint256" },
          { name: "optimalUtilization", type: "uint256" },
          { name: "maxUtilization", type: "uint256" },
      ...
      { name: "routerImplementation", type: "address", indexed: false },
      { name: "lendingPool", type: "address", indexed: false },
      { name: "lendingPoolImplementation", type: "address", indexed: false },
      { name: "sharesToken", type: "address", indexed: false },
    ],
  },
  {
    type: "event",
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "oftAddress", type: "address", indexed: true },
    ],
  },
  {
    type: "event",
    ...
    inputs: [
      { name: "tokenDataStream", type: "address", indexed: true },
    ],
  },
  {
    type: "event",
    ...
    inputs: [
      { name: "lendingPoolDeployer", type: "address", indexed: true },
    ],
  },
  {
    type: "event",
    ...
    inputs: [
      { name: "lendingPoolRouterDeployer", type: "address", indexed: true },
    ],
  },
  {
    type: "event",
  ...
  },
  {
    ...
    name: "IsHealthySet",
    inputs: [
      { name: "isHealthy", type: "address", indexed: true },
    ],
  },
  {
    type: "event",
    ...
    inputs: [
      { name: "positionDeployer", type: "address", indexed: true },
    ],
  },
  {
    type: "event",
    ...
    inputs: [
      { name: "wrappedNative", type: "address", indexed: true },
    ],
  },
  {
    type: "event",
    name: "DexRouterSet",
    inputs: [
      { name: "dexRouter", type: "address", indexed: true },
    ],
  },
  {
    type: "event",
    ...
    inputs: [
      { name: "token", type: "address", indexed: true },
      { name: "minAmountSupplyLiquidity", type: "uint256", indexed: true },
    ],
  },
  {
    type: "event",
    ...
    inputs: [
      { name: "interestRateModel", type: "address", indexed: true },
    ],
  },
  {
    type: "event",
  ...
  },
  {
    ...
    inputs: [
      { name: "proxyDeployer", type: "address", indexed: true },
    ],
  },
  {
    type: "event",
    ...
    inputs: [
      { name: "sharesTokenDeployer", type: "address", indexed: true },
    ],
  },
  {
    type: "event",
    name: "CreatorFeeSet",
    inputs: [
      { name: "lendingPoolRouter", type: "address", indexed: true },
      { name: "creatorFee", type: "uint256", indexed: true },
    ],
  },
  {
    type: "event",
    name: "SenjaEmitterSet",
    inputs: [
      { name: "senjaEmitter", type: "address", indexed: true },
    ],
  },
  {
    type: "event",
