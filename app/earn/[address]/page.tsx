...
export default function EarnDetailPage() {
  ...
  const { data: userData, refetch: refetchUser } = useReadContracts({
    ...
    query: { enabled: !!borrowTokenAddr && !!sharesTokenAddr && !!userAddress },
  });
  ...
  }, [supplyConfirmed, txStep, refetchRouter, refetchUser]);
              ...
              {!isConnected ? (
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-[var(--bg-secondary)] rounded-xl p-4">
                    <div className="text-xs text-[var(--text-tertiary)] mb-1">Supply Shares</div>
                    <div className="text-lg font-semibold text-[var(--text-primary)]">
                      {fmt(sharesBalance, 18)}
                    </div>
                    <div className="text-xs text-[var(--text-tertiary)]">shares</div>
                  </div>
                </div>
              )}
            </div>
